...
// import { useAuthToken } from "@/hooks/useAuthToken"; // ❌ Assigned but never used
...
interface NotificationBellProps {
  userId: string; // ✅ Now strongly typed as required
}
...
export default function NotificationBell({ userId }: NotificationBellProps) {
  ...
  // const token = useAuthToken(); // ❌ Assigned but never used
