  ...
  return (
    <section className="mt-10 px-4">
      ...
      <div className="flex flex-col md:flex-row gap-8 max-w-5xl mx-auto">
        {/* Card 1 */}
        <div className="flex-1 bg-gray-300 rounded-lg shadow-md p-6 flex flex-col items-center text-center">
          <FaExchangeAlt size={40} className="mb-3 text-[#037f44]" />
          <h3 className="text-xl font-semibold mb-2">Upgrade Hassle-Free</h3>
          <p>
        ...
        <div className="flex-1 bg-gray-300 rounded-lg shadow-md p-6 flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-semibold mb-2">Maximize Value</h3>
          <p>
